    ...
    <form method="post" align="center" class="form-signin">
        <form role="form">
            ...
            <div class="form-group">
                ...
                <textarea class="form-control" name="text" placeholder="*Обязательное поля для заполнения"></textarea>
            </div>
            <div class="form-group">
            ...
            <div class="form-group">
                ...
                <input type="text" name="pic2" class="form-control" id="exampleInputPassword1">
            </div>
            <div class="form-group">
            ...
            <div class="form-group">
                ...
                <input type="text" name="date" class="form-control" id="exampleInputPassword1" placeholder="*Обязательное поле для заполнения">
            </div>
